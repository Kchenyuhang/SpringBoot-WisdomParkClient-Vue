  ...
  methods: {
    ...
    onKeypress: function onKeypress(event) {
      ...
      if (event.keyCode === ENTER_CODE) {
        preventDefault(event); // trigger blur after click keyboard search button
  ...
  methods: {
    ...
    onAnimationEnd: function onAnimationEnd() {
      ...
      this.$nextTick(function () {
        ...
        _this.animationClass = notice_bar_bem('play--infinite');
    ...
    start: function start() {
      ...
      this.$nextTick(function () {
        ...
        if (_this2.scrollable && offsetWidth > wrapWidth) {
          ...
          _this2.animationClass = notice_bar_bem('play');
        } else {
          _this2.reset();
        }
      });
